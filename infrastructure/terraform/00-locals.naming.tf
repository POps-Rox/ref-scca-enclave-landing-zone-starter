...
locals {
  ...
  kv_cmk_hub_user_assigned_identity_name    = format("%s-%s-%s-%s-cmk-msi", var.org_name, module.mod_azregions_lookup.location_short, var.deploy_environment, local.hub_short_name)
  kv_cmk_id_user_assigned_identity_name     = format("%s-%s-%s-%s-cmk-msi", var.org_name, module.mod_azregions_lookup.location_short, var.deploy_environment, local.identity_short_name)
  kv_cmk_ops_user_assigned_identity_name    = format("%s-%s-%s-%s-cmk-msi", var.org_name, module.mod_azregions_lookup.location_short, var.deploy_environment, local.operations_short_name)
  kv_cmk_sec_user_assigned_identity_name    = format("%s-%s-%s-%s-cmk-msi", var.org_name, module.mod_azregions_lookup.location_short, var.deploy_environment, local.security_short_name)
  kv_cmk_devops_user_assigned_identity_name = format("%s-%s-%s-%s-cmk-msi", var.org_name, module.mod_azregions_lookup.location_short, var.deploy_environment, local.devsecops_short_name)
